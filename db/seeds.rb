...
Poster.create(
        user_id: 1,
        title: "멋쟁이 사자처럼 경기 하프톤",
        host: "멋쟁이 사자처럼",
        place: "광교 문화 센터 허브 홀",
        intro:"5월 27일 토요일 6개교가 함께하는,제 1회 경기연합하프톤이 진행됩니다!
                이번 하프톤은 5가지 키워드 관련 웹서비스 아이디어를 내고,
                를 통해 사전 팀빌딩을 하실 수 있습니다. 
                하루동안 기획부터 개발 및  다른 학교 친구들과 친목도 하는 하프톤이 될 예정입니다.
                좀 더 자세한 사항은 포스터 및 해당 학교 운영진님께 문의바랍니다.
                제 1회 경기 하프톤에서 만나요!!!",
        image:"poster/poster-1.png",
        start_date:"2017/05/27",
        end_date: "2017/05/27",
